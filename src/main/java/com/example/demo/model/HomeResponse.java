...
public class HomeResponse {
  ...
  public DailyStat getToday() {
    return today;
  }

  public void setToday(DailyStat today) {
    this.today = today;
  }

  public List<WeeklyStat> getWeeklyChart() {
    return weeklyChart;
  }

  public void setWeeklyChart(List<WeeklyStat> weeklyChart) {
    this.weeklyChart = weeklyChart;
  }

  public List<CalendarStat> getCalendarHistory() {
    return calendarHistory;
  }

  public void setCalendarHistory(List<CalendarStat> calendarHistory) {
